...
import com.valoser.hutaburakari.databinding.ActivityHistoryBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val touchHelper = ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT or ItemTouchHelper.RIGHT) {
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                // 監視も停止
                com.valoser.hutaburakari.worker.ThreadMonitorWorker.cancelByKey(this@HistoryActivity, item.key)
                // キャッシュ/アーカイブも削除
                com.valoser.hutaburakari.cache.DetailCacheManager(this@HistoryActivity).apply {
        ...
        R.id.action_clear_history -> {
            AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.ok) { _, _ ->
                    ...
                    // 監視を全停止
                    com.valoser.hutaburakari.worker.ThreadMonitorWorker.cancelAll(this)
                    // すべてのキャッシュ/アーカイブも削除
                    com.valoser.hutaburakari.cache.DetailCacheManager(this).clearAllCache()
                    refresh()
                }
