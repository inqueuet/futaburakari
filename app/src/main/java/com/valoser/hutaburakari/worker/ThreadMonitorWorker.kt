package com.valoser.hutaburakari.worker
...
import com.valoser.hutaburakari.HistoryManager
import com.valoser.hutaburakari.NetworkClient
import com.valoser.hutaburakari.UrlNormalizer
import org.jsoup.nodes.Document
import org.jsoup.nodes.Element
import java.util.concurrent.TimeUnit
import java.net.MalformedURLException
import java.net.URL
import com.valoser.hutaburakari.DetailContent
...
class ThreadMonitorWorker(appContext: Context, params: WorkerParameters) : CoroutineWorker(appContext, params) {
    ...
    companion object {
        ...
        const val PREFS_BG = "com.valoser.hutaburakari.bg"
    ...
    private fun archiveMedia(context: Context, threadUrl: String, list: List<DetailContent>): List<DetailContent> {
        ...
        fun ensureDownloaded(remoteUrl: String): String? {
            ...
            return try {
                val req = Request.Builder().url(remoteUrl).header("User-Agent", com.valoser.hutaburakari.Ua.STRING).build()
                val resp = com.valoser.hutaburakari.NetworkModule.okHttpClient.newCall(req).execute()
                resp.use { r ->
